  ...
  return (
    <Card className="group overflow-hidden border-0 shadow-elegant hover:shadow-gold transition-all duration-500 hover:-translate-y-2">
      <CardContent className="p-0">
        ...
        <Button
          size="icon"
          className="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-secondary hover:bg-secondary/90 text-primary shadow-gold z-10"
          onClick={(e) => {
            e.preventDefault();
            addToCart(id);
          }}
        ...
        <Link to={`/product/${id}`}>
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="flex items-center gap-2 pt-1">
              <span className="text-xl font-bold">UGX {price.toLocaleString()}</span>
              {originalPrice && (
